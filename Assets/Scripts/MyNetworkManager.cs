...
public class MyNetworkManager : NetworkManager
{
    ...
    { 
        ...
        {
            //get first prefab in spawnable prefabs list on this network manager
            ...
            //spawn a playercontroller for player 1
            var player1PC = spawnPrefabs[2];
            
            GameManager._instance._playerController = player1PC.GetComponent<PlayerController>(); 

            var player2Prefab = spawnPrefabs[1];
            var player2Instance = Instantiate(player2Prefab);
            NetworkServer.Spawn(player2Instance);
